...
def generate_bitcoin_keypair_range(start_hex, end_hex, target_address):
    ...
    with open("resultados.txt", "w") as file:
        for private_key_int in range(start_int, end_int - 999000000000):
...
if __name__ == "__main__":
    initial_private_key_hex = "000000000000000000000000000000000000000000000003ffffffffffffffff"
    final_private_key_hex   = "0000000000000000000000000000000000000000000000020000000010000000"
