...
def generate_bitcoin_keypair_range(start_hex, end_hex, target_address_prefix):
    ...
    with open("inverte-99000.txt", "w") as file:
        for private_key_int in range(end_int, start_int - 99000, -1):  # Loop inverso
            ...
            match_percentage = calculate_match_percentage(target_address_prefix, bitcoin_address)
            if match_percentage > max_match_percentage : # and bitcoin_address.startswith(target_address_prefix):
            ...
            if match_percentage > 23 and bitcoin_address.startswith("13"):
...
if __name__ == "__main__":
    ...
    final_private_key_hex   = "000000000000000000000000000000000000000000000003fffffffff0093783"
    target_address_prefix   = "13zb1hQbWVsc2S7ZTZnP2G4undNNpdh5so"
    generate_bitcoin_keypair_range(initial_private_key_hex, final_private_key_hex, target_address_prefix)
