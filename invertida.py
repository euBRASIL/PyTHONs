...
def generate_bitcoin_keypair_range(start_hex, end_hex, target_address_prefix):
    ...
    with open("invertida.txt", "w") as file:
        for private_key_int in range(end_int, start_int - 999000000000, -1):  # Loop inverso
...
if __name__ == "__main__":
    ...
    final_private_key_hex   = "000000000000000000000000000000000000000000000003ffffffffe20e802d"
