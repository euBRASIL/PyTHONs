...
import io  # Adicionando importação para o módulo io
...
def Downloader():
    try:
        ...
        def download_video():
            ...
            root.after(0, lambda: Label(root, text='Download efetuado com êxito', font='arial 11 bold', bg='blue', fg='white').place(x=10, y=330))
